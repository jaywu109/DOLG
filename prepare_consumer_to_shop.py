...
def main():
    parser = argparse.ArgumentParser('Consumer to shop dataset preparing')
    parser.add_argument('-i', '--input', required=True, help='path of the consumer-to-shop root directory')
